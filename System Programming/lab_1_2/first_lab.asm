...
section .text                                                   ;директива кода
    ...
    function: 
        ...
        sub esp, 16                                             ;выделяем место в стеке под локальные переменные (нам хватит трех)
    ...
    divide_by_zero_ex:
        push ebp
        mov ebp, esp
        PRINT zero_message, format_text
        mov esp, ebp
        pop ebp
        call exit
