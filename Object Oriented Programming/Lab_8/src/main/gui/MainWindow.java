...
//        String msg = ResourceBundle.getBundle(PATH_TO_RESOURCES).getString("enter.step");
        ...
        if (!isEmptyTable()) {
            try {
                if (functionHandler.isFilenameAssigned()) {
                    String msg = setUpText("save.dialog");
                    int code = JOptionPane.showConfirmDialog(this, msg,"SaveDialog",
    ...
    private void updateWindow() {
        ...
        calculateButton.setText(setUpText("calc.btn"));
        resultsLabel.setText(setUpText("results.label"));
    }
